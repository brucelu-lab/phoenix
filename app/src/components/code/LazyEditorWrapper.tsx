...
export function LazyEditorWrapper({
  ...
  /**
   * The IntersectionObserver below initializes the JSON editor on first scroll-into-view.
   ...
   * invisible or cut off when scrolled into view. We latch `isInitialized` to true the first
   * time the wrapper intersects and never revert it.
